...
// ADC attribute IDs
const std::map<std::string, int64_t> adc_attrids = {
    {"CLK_SEL", 0},
    {"DIV_CTL", 1},
    {"PHASE_SEL", 2},
    {"UNK0", 3},
...
// ADC attribute values
const std::map<std::string, int64_t> adc_attrvals = {
    {"UNKNOWN", 0},
    {"DIV_1", 2},
    {"DIV_2", 4},
    {"DIV_3", 8},
...
// PLL attribute values
const std::map<std::string, int64_t> pll_attrvals = {
    {"UNKNOWN", 0},
    {"FALSE", 0},
    {"BYPASS", 1},
    {"DISABLE", 2},
...
// BSRAM attribute IDs
const std::map<std::string, int64_t> bsram_attrids = {
    {"CEMUX_CEA", 0},
    {"CEMUX_CEB", 1},
    {"CLKMUX_CLKA", 2},
    {"CLKMUX_CLKB", 3},
...
// BSRAM attribute values
const std::map<std::string, int64_t> bsram_attrvals = {
    {"UNKNOWN", 0},
    {"INV", 1},
    {"ENABLE", 2},
    {"SET", 3},
...
// DSP attribute IDs
const std::map<std::string, int64_t> dsp_attrids = {
    {"CEHMUX_CREG", 0},
    {"CEHMUX_OREG0", 1},
    {"CEHMUX_OREG1", 2},
    {"CEHMUX_REGA0", 3},
...
// DSP attribute values
const std::map<std::string, int64_t> dsp_attrvals = {
    {"UNKNOWN", 0},
    {"EN", 1},
    {"ENABLE", 2},
    {"1", 3},
...
// DCS attribute IDs
const std::map<std::string, int64_t> dcs_attrids = {
    {"1", 1},
    {"2", 0},
    {"3", 2},
    {"4", 3},
...
// DCS attribute values
const std::map<std::string, int64_t> dcs_attrvals = {
    {"UNKNOWN", 0},
    {"FALLING", 1},
    {"RISING", 2},
    {"CLK0", 3},
...
// DLLDLY attribute IDs
const std::map<std::string, int64_t> dlldly_attrids = {
    {"ENABLED", 0},
    {"LOADN", 2},
    {"SIGN", 3},
    {"MODE", 4},
...
// DLLDLY attribute values
const std::map<std::string, int64_t> dlldly_attrvals = {
    {"UNKNOWN", 0},
    {"ENABLE", 1},
    {"NORMAL", 3},
    {"1", 4},
...
// DLL attribute IDs
const std::map<std::string, int64_t> dll_attrids = {
    {"CLKSEL", 0},
    {"CODESCAL", 1},
    {"CODESCALEN", 2},
    {"DIVSEL", 3},
...
// DLL attribute values
const std::map<std::string, int64_t> dll_attrvals = {
    {"UNKNOWN", 0},
    {"HECLK0", 1},
    {"HECLK1", 2},
    {"HECLK2", 3},
...
// Oscillator attribute IDs
const std::map<std::string, int64_t> osc_attrids = {
    {"MCLKCIB", 0},
    {"NORMAL", 1},
    {"POWER_SAVE", 2},
    {"USERPOWER_SAVE", 3},
...
// Oscillator attribute values
const std::map<std::string, int64_t> osc_attrvals = {
    {"UNKNOWN", 0},
    {"ENABLE", 1},
    {"ON", 2},
};

// Config attribute IDs
const std::map<std::string, int64_t> cfg_attrids = {
    {"DONE_AS_GPIO", 0},
    {"GWD", 1},
    {"GSR", 2},
    {"GOE", 3},
...
const std::map<std::string, int64_t> cfg_attrvals = {
    {"UNKNOWN", 0},
    {"YES", 1},
    {"ACTIVE_LOW", 2},
    {"F0", 3},
...
// Global Set/Reset attribute IDs
const std::map<std::string, int64_t> gsr_attrids = {
    {"GSRMODE", 0},
    {"SYNCMODE", 1},
};

// Global Set/Reset attribute values
const std::map<std::string, int64_t> gsr_attrvals = {
    {"UNKNOWN", 0},
    {"ACTIVE_LOW", 1},
    {"SYNC", 2},
};
...
// HCLK attribute IDs
const std::map<std::string, int64_t> hclk_attrids = {
    {"BK00DIV2_RST", 0},
    {"BK01DIV2_RST", 1},
    {"BK0MUX0_OUTSEL", 2},
    {"BK0MUX1_OUTSEL", 3},
...
// HCLK attribute values
const std::map<std::string, int64_t> hclk_attrvals = {
    {"UNKNOWN", 0},
    {"DIVCIBRST2", 1},
    {"DIVCIBRST3", 2},
    {"DIV2", 3},
...
// IOLOGIC attribute IDs
const std::map<std::string, int64_t> iologic_attrids = {
    {"INMODE", 0},
    {"OUTMODE", 1},
    {"SRMODE", 2},
    {"CLKIDDRMUX", 3},
...
// IOLOGIC attribute values
const std::map<std::string, int64_t> iologic_attrvals = {
    {"UNKNOWN", 0},
    {"0", 1},
    {"1", 2},
    {"INV", 3},
