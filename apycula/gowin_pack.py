...
def set_multalu18x18_attrs(db, typ, params, num, attrs, dsp_attrs, mac):
    ...
    set_dsp_regs_0(parms, {'AREG', 'BREG', 'CREG', 'DREG', 'DSIGN_REG', 'ASIGN_REG', 'BSIGN_REG', 'PIPE_REG', 'OUT_REG'})
...
def set_multaddalu18x18_attrs(db, typ, params, num, attrs, dsp_attrs, mac):
    ...
    set_dsp_regs_0(parms, {'A0REG', 'A1REG', 'B0REG', 'B1REG', 'CREG', 'PIPE0_REG', 'PIPE1_REG', 'OUT_REG',
...
def set_multalu36x18_attrs(db, typ, params, num, attrs, dsp_attrs, mac):
    ...
    set_dsp_regs_0(parms, {'AREG', 'BREG', 'CREG', 'PIPE_REG', 'OUT_REG', 'ASIGN_REG', 'BSIGN_REG', 'ACCLOAD_REG0',
                           'ACCLOAD_REG1'}
    for parm, val in params.items():
        if parm == 'AREG':
            if val == '0':
...
def set_alu54d_attrs(db, typ, params, num, attrs, dsp_attrs, mac):
    ...
    set_dsp_regs_0(parms, {'AREG', 'BREG', 'OUT_REG', 'ACCLOAD_REG'}
    for parm, val in params.items():
        if parm == 'ALUD_MODE':
            ival = int(val, 2)
            if ival == 2:
...
def set_padd9_attrs(db, typ, params, num, attrs, dsp_attrs, mac, idx, even_odd, pair_idx):
    ...
    set_dsp_regs_0(parms, {'AREG', 'BREG'}
    for parm, val in params.items():
        if parm == 'AREG':
            if val == '0':
                if even_odd:
...
def set_mult9x9_attrs(db, typ, params, num, attrs, dsp_attrs, mac, idx, even_odd, pair_idx):
    ...
    set_dsp_regs_0(parms, {'AREG', 'BREG', 'OUT_REG', 'PIPE_REG', 'ASIGN_REG', 'BSIGN_REG', 'SOA_REG'}
    for parm, val in params.items():
        if parm == 'AREG':
            if val == '0':
                if even_odd:
...
def set_dsp_mult36x36_attrs(db, typ, params, attrs):
    ...
    set_dsp_regs_0(parms, {'AREG', 'BREG', 'ASIGN_REG', 'BSIGN_REG'}
    # macro 0
    dsp_attrs = {}
