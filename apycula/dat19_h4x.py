...
pos = print_arr16(['Bank', 'TB'], pos, 200, grid_w)
pos = print_arr16(['Bank', 'BB'], pos, 200, grid_w)
pos = print_arr16(['Bank', 'LB'], pos, 150, grid_w)
pos = print_arr16(['Bank', 'RB'], pos, 150, grid_w)
...
pos = print_arr16(['X16', 'TB'], pos, 200, grid_w)
pos = print_arr16(['X16', 'BB'], pos, 200, grid_w)
pos = print_arr16(['X16', 'LB'], pos, 150, grid_w)
pos = print_arr16(['X16', 'RB'], pos, 150, grid_w)
