...
pos = 0x2dee4
for i in range(10):
    pos = print_arr8(f'SpecIOL/{i}', pos, 10, 10)
print()
for i in range(10):
    pos = print_arr8(f'SpecIOR/{i}', pos, 10, 10)
print(hex(pos))
...
#print(hex(pos))
for i in range(320):
    pos = print_arr16(f'CiuConnection/{i}', pos, 60)
pos = print_arr16(f'CiuFanoutNum', pos, 320)
for i in range(320):
    pos = print_arr16(f'CiuBdConnection/{i}', pos, 60)
pos = print_arr16(f'CiuBdFanoutNum', pos, 320)
for i in range(320):
    pos = print_arr16(f'CiuCornerConnection/{i}', pos, 60)
pos = print_arr16(f'CiuCornerFanoutNum', pos, 320)
for i in range(106):
    pos = print_arr16(f'CmuxInNodes/{i}', pos, 73)
for i in range(106):
    pos = print_arr16(f'CmuxIns/{i}', pos, 3)
print()
